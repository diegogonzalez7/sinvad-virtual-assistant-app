...
const ChatScreen = ({
  ...
  return (
    <KeyboardAvoidingView
      ...
      keyboardVerticalOffset={Platform.OS === 'ios' ? 64 : 0} // Poner otro valor para Android si se solapa con el teclado
    >
      <View style={[styles.container, { paddingTop: insets.top, flex: 1 }]}>
            ...
            {options.length > 0 && options[0].isTextInput ? (
              <View style={styles.inputWrapper}>
                <TextInput
                  ...
                  autoFocus // Opcional: enfoca automáticamente el TextInput
                />
                <TouchableOpacity
        ...
        {currentStepId !== '0' && (
          <TouchableOpacity
            ...
            onPress={() => {
              Alert.alert('¿Desea volver?', 'El avance realizado en este flujo se descartará.', [
